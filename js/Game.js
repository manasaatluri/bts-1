...
console.log("hai not working or "+imagek)
  if(imagek==1){
       ...
       image(v,500,500,500,500)
    }
    if(imagek==2){
      console.log("eryt"+imagek)
     image(kook,500,500,500,500)
  }
  if(imagek==3){
    console.log("yrs"+imagek)
   image(namjoon,500,500,500,500)
}
if(imagek==4){
  console.log("jdksfdskjf"+imagek)
 image(jin,500,500,500,500)
}
if(imagek==5){
  console.log("jdksfdskjf"+imagek)
 image(jimin,500,500,500,500)
}
if(imagek==6){
  console.log("jdksfdskjf"+imagek)
 image(jhope,500,500,500,500)
}
if(imagek==7){
  console.log("jdksfdskjf"+imagek)
 image(sug,500,500,500,500)
}
}
 end(){
  background("lightblue")
